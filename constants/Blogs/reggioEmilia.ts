...
export const reggioEmilia : Blog = {
  ...
  "content": [
    {
      "type": "PARAGRAPH",
      "text": "The Reggio Emilia Approach is not a prescriptive curriculum; it is a philosophy forged in fire and hope. Its origin story begins not in an academic lecture hall, but in the small town of Reggio Emilia, Italy, in the immediate aftermath of World War II. The community, shattered yet resolute, decided that the only way forward was to invest everything in the future of their children. Parents pooled their money and labor, collecting remnants from war wreckage, such as wood, bricks, and metal, to literally build their first school from the ground up. This was a profound declaration: a new education rooted in cooperation, dignity, and democratic possibility.\n",
      "size": "BASE",
      "weight": "NORMAL",
      "style": "NONE",
      "alignment": "LEFT",
